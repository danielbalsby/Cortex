...
8. **Do not duplicate documentation.** Derive outputs from recorded consultation information; never request duplicate entry solely to populate a document.
...
14. **Avoid unnecessary animation or visual noise.** Motion may clarify a state change but must not decorate, distract or delay work.
